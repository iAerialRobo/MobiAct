...
modal_num = 1  # Change to 1 for single-modality training/testing
...
def plot_confusion_matrix(y_true, y_pred, class_names, normalize=True, figsize=(10, 8), cmap='Blues', suffix='', modal_num=1):
...
def plot_per_class_f1_scores(f1_scores, class_names, title, suffix='',modal_num=1):
    suffix = f'_{suffix}_mobilenetv4_single' if modal_num == 1 else f'_{suffix}_mobilenetv4_multimodal'
    plt.figure(figsize=(10, 6))
...
class MultimodalWorkoutDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.modal_num == 3:
            ...
            return rgb_tensor, rgb_tensor, rgb_tensor, label_tensor
